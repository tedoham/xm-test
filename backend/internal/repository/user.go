...
func (repo *PostgresRepository) GetUserByID(ctx context.Context, userID string) (*domain.User, error) {
...
func (repo *PostgresRepository) UpdateUsername(ctx context.Context, user *domain.User) error {
	user.UpdatedAt = time.Now()
...
func (repo *PostgresRepository) StoreVerificationData(ctx context.Context, verificationData *domain.VerificationData) error {
...
func (repo *PostgresRepository) GetVerificationData(ctx context.Context, email string, verificationDataType domain.VerificationDataType) (*domain.VerificationData, error) {
...
func (repo *PostgresRepository) DeleteVerificationData(ctx context.Context, email string, verificationDataType domain.VerificationDataType) error {
